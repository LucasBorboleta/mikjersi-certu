...
"""mikjersi_build_app.py builds a one-file executable for Windows OS."""
...
print()
print("Building mikjersi_certu application ...")
os.chdir(os.path.join(_product_home, "mikjersi_certu"))
...
if os.path.isfile("mikjersi_certu.spec"):
   os.remove("mikjersi_certu.spec") 
...
print()
print("Building mikjersi_certu application done")
